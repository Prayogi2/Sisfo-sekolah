    ...
    <div class="container-fluid">
        ...
        <form action="{{ $isNew ? route('admin.data-siswa.store') : route('admin.buku-induk.update', $student) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="col-md-4"><label class="form-label">NISN <span class="text-danger">*</span></label><input name="nisn" class="form-control" value="{{ $value('nisn', $student->nisn) }}" inputmode="numeric" pattern="[0-9]{10}" maxlength="10" title="NISN harus 10 digit angka" required></div>
                ...
                <div class="col-md-4"><label class="form-label">Tanggal Lahir</label><input name="birth_date" type="date" class="form-control" value="{{ $value('birth_date', $student->birth_date?->format('Y-m-d')) }}" max="{{ now()->subDay()->format('Y-m-d') }}"></div>
            ...
            <div class="card shadow-sm mb-4"><div class="card-header bg-white"><h6 class="mb-0 fw-bold text-primary"><i class="bi bi-clock-history me-2"></i>Riwayat Pendidikan</h6></div><div class="card-body">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3"><label class="form-label">No. Seri Rapor</label><input name="report_book_serial_number" class="form-control" maxlength="100" value="{{ $value('report_book_serial_number', $academic?->report_book_serial_number) }}"></div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3"><label class="form-label">No. Ujian</label><input name="exam_number" class="form-control" maxlength="50" value="{{ $value('exam_number', $academic?->exam_number) }}" placeholder="mis. 2-26-05-01-001-002-3"></div>
                    <div class="col-md-3"><label class="form-label">No. Seri Ijazah</label><input name="graduation_certificate_number" class="form-control" maxlength="100" value="{{ $value('graduation_certificate_number', $academic?->graduation_certificate_number) }}"></div>
                    ...
                    <div class="col-md-6"><label class="form-label">Melanjutkan ke Sekolah</label><input name="continued_to" class="form-control" value="{{ $value('continued_to', $academic?->continued_to) }}"></div>
