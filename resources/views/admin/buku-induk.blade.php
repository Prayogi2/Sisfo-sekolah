            ...
            <div class="tab-content bg-white p-4 rounded shadow-sm border-0">
                ...
                <div class="tab-pane fade" id="riwayat" role="tabpanel">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4"><label class="form-label small text-muted">No. Seri Rapor</label><input type="text" class="form-control bg-light" value="{{ $academicRecord?->report_book_serial_number ?: '-' }}" readonly></div>
                ...
                <div class="tab-pane fade" id="lulus" role="tabpanel">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><label class="form-label small text-muted">No. Ujian</label><input type="text" class="form-control bg-light" value="{{ $academicRecord?->exam_number ?: '-' }}" readonly></div>
