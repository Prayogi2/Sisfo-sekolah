...
<body>
    ...
    <script>
        ...
        sakelar.addEventListener('change', function() {
            if(!this.checked) {
                warningSakelar.style.display = 'block';
            } else {
                warningSakelar.style.display = 'none';
            }
        });

        // Dummy Auto Scanner
        // Jam 07:15:00 adalah batas telat (07 jam, 15 menit, 0 detik)
        const dummyScans = [
        ...
        function simulateScan() {
            ...
            // Jika telat tapi sakelar dimatikan
